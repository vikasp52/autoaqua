...
class MyAppSMS extends StatefulWidget {
  @override
  _MyAppSMSState createState() => new _MyAppSMSState();
}

class _MyAppSMSState extends State<MyAppSMS> {
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  if ((people == null || people.isEmpty) || (body == null || body.isEmpty)) {
